...
export default function Entrepenuer(props) {
  const { overrides: overridesProp, ...rest } = props;
  const variants = [
    {
      overrides: {
        "99a46f44-9192-40ce-9daf-61738927754e 1": {},
        Eyebrow: {},
        Heading: {},
        Body: {},
        Message: {},
  ...
  return (
    <Flex
      ...
      display="flex"
      {...getOverrideProps(overrides, "Entrepenuer")}
      {...rest}
    >
      <Image
        width="567px"
        ...
        padding="0px 0px 0px 0px"
        objectFit="cover"
        src="https://images.unsplash.com/photo-1613592237010-a29414f72d61?q=80&w=2370&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        {...getOverrideProps(
          overrides,
          "99a46f44-9192-40ce-9daf-61738927754e 1"
        )}
